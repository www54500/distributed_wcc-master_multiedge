...
public class CommunityInitializationComputation 
  ...
  public static boolean initializeCommunity(
    ...
    vData.setCommInitNeighbors(new CommunityInitMessageArrayWritable(commInitNeighbors));
...
//      (CommunityInitializationMessage[]) vData.getCommInitNeighbors().get();
    ...
    Writable[] commInitNeighbors = vData.getCommInitNeighbors().get();
...
//      CommunityInitializationMessage[] commInitNeighbors) {
    ...
    HashMap<Integer, CommunityInitializationMessage> commInitNeighborsMap = new HashMap(commInitNeighbors.length);
