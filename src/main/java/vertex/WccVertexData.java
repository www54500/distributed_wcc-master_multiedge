...
public class WccVertexData implements Writable {
   ...
   *   Used for preprocessing
   *   can accept duplicate neighbors
   */
  private ArrayPrimitiveWritable neighbors;
  
  private int numNonDupEdges;
  ...
  public int getNumNonDupEdges() { return numNonDupEdges;}
  ...
  public void setNumNonDupEdges(int nnde) {
    this.numNonDupEdges = nnde;
  }
  ...
  public void write(DataOutput output) throws IOException {
    ...
    output.writeInt(numNonDupEdges);
  }
